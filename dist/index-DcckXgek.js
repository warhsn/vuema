...
function z(t) {
  t.component("column", s(() => import("./column-DFEEo01k.js"))), t.component("columns", s(() => import("./columns-CNwTQcJ_.js"))), t.component("flex", s(() => import("./flex-CYb1jdmr.js")));
}
function F(t) {
  t.component("base-icon", s(() => import("./base-icon-D9TihyI9.js"))), t.component("action-button", s(() => import("./button-CecB7Pv-.js"))), t.component("icon-button", s(() => import("./icon-button-BiahoDPt.js"))), t.component("submit-button", s(() => import("./submit-button-BBryhJxf.js"))), t.component("buttons", s(() => import("./buttons-DZb92DV0.js"))), t.component("loader", s(() => import("./loader-CvX_dPee.js"))), t.component("block", s(() => import("./block-2Hy_WRVB.js"))), t.component("box", s(() => import("./box-CB8bYq7W.js"))), t.component("b-icon", s(() => import("./icon-XTRTXlk0.js"))), t.component("avatar", s(() => import("./avatar-Qs3jleId.js")));
}
function O(t) {
  t.component("side-menu", s(() => import("./side-menu-DJAAXk05.js"))), t.component("side-menu-label", s(() => import("./side-menu-label-B-tWfOXe.js"))), t.component("side-menu-list", s(() => import("./side-menu-list-BSNdJdY_.js"))), t.component("side-menu-list-item", s(() => import("./side-menu-list-item-C6lxSFjn.js"))), t.component("dropdown", s(() => import("./dropdown-BFSCP8ZA.js"))), t.component("dropdown-divider", s(() => import("./dropdown-divider-C6QqPPur.js"))), t.component("dropdown-item", s(() => import("./dropdown-item-BU3bgDwG.js"))), t.component("dropdown-trigger", s(() => import("./dropdown-trigger-DTlJTm2u.js"))), t.component("modal", s(() => import("./modal-C5xJoYjS.js"))), t.component("confirm", s(() => import("./confirm-dialog-D2lNlEAL.js"))), t.component("alert", s(() => import("./alert-dialog-Cx7UVq1h.js"))), t.component("tabs", s(() => import("./tabs-BgHChJGc.js"))), t.component("tab", s(() => import("./tab-DkodDZA8.js"))), t.component("pagination", s(() => import("./pagination-C8Y1xs4n.js")));
}
function N(t) {
  t.component("field-label", s(() => import("./field-label-BlqTt41h.js"))), t.component("text-input", s(() => import("./text-input-DB1TqUbb.js"))), t.component("password-input", s(() => import("./password-input-CYj3PcqC.js"))), t.component("text-area", s(() => import("./text-area-BLLtHf0h.js"))), t.component("select-input", s(() => import("./select-input-CDT_VF1_.js"))), t.component("radio-input", s(() => import("./radio-input-B1Dp5itf.js"))), t.component("checkbox-input", s(() => import("./checkbox-input-B_xSXtDh.js"))), t.component("switch-input", s(() => import("./switch-input-DqyyquBs.js"))), t.component("currency-input", s(() => import("./currency-input-D08wAQyo.js"))), t.component("tag-input", s(() => import("./tag-input-CFTLx0Um.js"))), t.component("file-input", s(() => import("./file-input-DZouJbmP.js"))), t.component("number-input", s(() => import("./number-input-C9Yumz5J.js"))), t.component("date-picker", s(() => import("./date-picker-BqVprIgT.js"))), t.component("time-input", s(() => import("./time-input-IRoEV9yT.js")));
}
const H = {
  position: "top",
  color: "dark",
