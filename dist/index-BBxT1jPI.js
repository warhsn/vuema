...
function q(t) {
  t.component("column", s(() => import("./column-DFEEo01k.js"))), t.component("columns", s(() => import("./columns-CNwTQcJ_.js"))), t.component("flex", s(() => import("./flex-Bmb2RrLr.js")));
}
function J(t) {
  t.component("base-icon", s(() => import("./base-icon-BYFjiGHr.js"))), t.component("action-button", s(() => import("./button-BAAMBYA_.js"))), t.component("icon-button", s(() => import("./icon-button-CwHwxzPR.js"))), t.component("submit-button", s(() => import("./submit-button-Bn_nFpJX.js"))), t.component("buttons", s(() => import("./buttons-DZb92DV0.js"))), t.component("loader", s(() => import("./loader-CQfpcFnK.js"))), t.component("block", s(() => import("./block-CaP0VTVp.js"))), t.component("box", s(() => import("./box-aeSF_nSm.js"))), t.component("b-icon", s(() => import("./icon-QkQXAd6B.js"))), t.component("avatar", s(() => import("./avatar-BLY8bpEd.js")));
}
function G(t) {
  t.component("side-menu", s(() => import("./side-menu-BzczCXDI.js"))), t.component("side-menu-label", s(() => import("./side-menu-label-C86_3toX.js"))), t.component("side-menu-list", s(() => import("./side-menu-list-C1b753fa.js"))), t.component("side-menu-list-item", s(() => import("./side-menu-list-item-CBZ5S7Eg.js"))), t.component("dropdown", s(() => import("./dropdown-yeKJXV90.js"))), t.component("dropdown-divider", s(() => import("./dropdown-divider-B9k0ADkI.js"))), t.component("dropdown-item", s(() => import("./dropdown-item-BU3bgDwG.js"))), t.component("dropdown-trigger", s(() => import("./dropdown-trigger-DTlJTm2u.js"))), t.component("modal", s(() => import("./modal-B5xyogKR.js"))), t.component("confirm", s(() => import("./confirm-dialog-BpLP07Yn.js"))), t.component("alert", s(() => import("./alert-dialog-BvvqFNT0.js"))), t.component("tabs", s(() => import("./tabs-BgHChJGc.js"))), t.component("tab", s(() => import("./tab-DkodDZA8.js"))), t.component("pagination", s(() => import("./pagination-BeFhmLf7.js"))), t.component("steps", s(() => import("./steps-BAerra1F.js")));
}
function K(t) {
  t.component("field-label", s(() => import("./field-label-BPGAcVCp.js"))), t.component("field-error", s(() => import("./field-error-B_nqpbkA.js"))), t.component("text-input", s(() => import("./text-input-C9dB0AG1.js"))), t.component("password-input", s(() => import("./password-input-CH5REUQz.js"))), t.component("text-area", s(() => import("./text-area-6XpXO9I0.js"))), t.component("select-input", s(() => import("./select-input-DCXVDHrA.js"))), t.component("radio-input", s(() => import("./radio-input-CtE5UlJ8.js"))), t.component("checkbox-input", s(() => import("./checkbox-input-Bpd318h_.js"))), t.component("color-picker", s(() => import("./color-picker-DXAIrb8E.js"))), t.component("switch-input", s(() => import("./switch-input-BRhrIyMI.js"))), t.component("currency-input", s(() => import("./currency-input-CCdAZz29.js"))), t.component("tag-input", s(() => import("./tag-input-CpBTfq7I.js"))), t.component("file-input", s(() => import("./file-input-BKdZbe6E.js"))), t.component("number-input", s(() => import("./number-input-C-plLrOu.js"))), t.component("date-picker", s(() => import("./date-picker-CU7IEp1_.js"))), t.component("time-input", s(() => import("./time-input--crcw-Kj.js"))), t.component("search-input", s(() => import("./search-input-DceNcstJ.js"))), t.component("phone-input", s(() => import("./phone-input-Bcwy2YXc.js"))), t.component("drag-drop-uploader", s(() => import("./drag-drop-uploader-7JV4Si1G.js")));
}
const Q = {
  position: "top",
  color: "dark",
