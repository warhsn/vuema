...
import { _ as re } from "./index-B-YS7fh8.js";
    ...
    return le(() => l.modelValue, (e) => {
      ...
      return i(), p("div", null, [
        e.$slots.default || e.$slots.description ? (i(), T(n, {
          ...
          description: O(() => [
            A(e.$slots, "description", {}, void 0, !0)
          ]),
          default: O(() => [
        ...
        w("div", de, [
          e.modelValue && e.modelValue.length > 0 ? (i(), p("div", ce, [
            (i(!0), p(j, null, q(e.modelValue, (t, h) => (i(), p("span", {
              class: "tag",
              key: N(t, h)
            }, [
              ne(K(R(t)) + " ", 1),
          ...
          r.value && (c.value.length > 0 || y.value) ? (i(), p("div", fe, [
            w("div", me, [
              (i(!0), p(j, null, q(c.value, (t, h) => (i(), p("a", {
                key: N(t, h),
