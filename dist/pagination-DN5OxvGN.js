import { defineComponent as v, getCurrentInstance as T, computed as w, createElementBlock as c, createCommentVNode as u, openBlock as f, createElementVNode as n, normalizeClass as o, unref as d, toDisplayString as i } from "vue";
import { u as C } from "./sizes-tLhbz8lD.js";
import { _ as S } from "./index-CQJAgQa1.js";
const k = {
  key: 0,
  ...
  setup(e) {
    ...
    return (l, t) => e.pager.total > 0 ? (f(), c("div", k, [
      n("nav", {
...
}), E = /* @__PURE__ */ S(b, [["__scopeId", "data-v-c0e89cf0"]]);
export {
  E as default
};
