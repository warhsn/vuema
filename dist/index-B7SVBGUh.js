...
function q(t) {
  t.component("column", s(() => import("./column-DFEEo01k.js"))), t.component("columns", s(() => import("./columns-CNwTQcJ_.js"))), t.component("flex", s(() => import("./flex-DErdw1_I.js")));
}
function J(t) {
  t.component("base-icon", s(() => import("./base-icon-BYFjiGHr.js"))), t.component("action-button", s(() => import("./button-BAAMBYA_.js"))), t.component("icon-button", s(() => import("./icon-button-CwHwxzPR.js"))), t.component("submit-button", s(() => import("./submit-button-Bn_nFpJX.js"))), t.component("buttons", s(() => import("./buttons-DZb92DV0.js"))), t.component("loader", s(() => import("./loader-CGe1TLqD.js"))), t.component("block", s(() => import("./block-B1C6RB4s.js"))), t.component("box", s(() => import("./box-C_OX3qIh.js"))), t.component("b-icon", s(() => import("./icon-QkQXAd6B.js"))), t.component("avatar", s(() => import("./avatar-BLY8bpEd.js")));
}
function G(t) {
  t.component("side-menu", s(() => import("./side-menu-Cibq3DSV.js"))), t.component("side-menu-label", s(() => import("./side-menu-label-DNwVcbtP.js"))), t.component("side-menu-list", s(() => import("./side-menu-list-C-1sNJ8W.js"))), t.component("side-menu-list-item", s(() => import("./side-menu-list-item-BZd1vaK1.js"))), t.component("dropdown", s(() => import("./dropdown-yeKJXV90.js"))), t.component("dropdown-divider", s(() => import("./dropdown-divider-yGfUAIbr.js"))), t.component("dropdown-item", s(() => import("./dropdown-item-BU3bgDwG.js"))), t.component("dropdown-trigger", s(() => import("./dropdown-trigger-DTlJTm2u.js"))), t.component("modal", s(() => import("./modal-B5xyogKR.js"))), t.component("confirm", s(() => import("./confirm-dialog-BpLP07Yn.js"))), t.component("alert", s(() => import("./alert-dialog-BvvqFNT0.js"))), t.component("tabs", s(() => import("./tabs-BgHChJGc.js"))), t.component("tab", s(() => import("./tab-DkodDZA8.js"))), t.component("pagination", s(() => import("./pagination-ZmlL-kmb.js"))), t.component("steps", s(() => import("./steps-CUXB34Y7.js")));
}
function K(t) {
  t.component("field-label", s(() => import("./field-label-CFVYVEYE.js"))), t.component("field-error", s(() => import("./field-error-B_nqpbkA.js"))), t.component("text-input", s(() => import("./text-input-C9dB0AG1.js"))), t.component("password-input", s(() => import("./password-input-CH5REUQz.js"))), t.component("text-area", s(() => import("./text-area-6XpXO9I0.js"))), t.component("select-input", s(() => import("./select-input-DCXVDHrA.js"))), t.component("radio-input", s(() => import("./radio-input-CtE5UlJ8.js"))), t.component("checkbox-input", s(() => import("./checkbox-input-Bpd318h_.js"))), t.component("color-picker", s(() => import("./color-picker-BIotDO32.js"))), t.component("switch-input", s(() => import("./switch-input-Dh_BR8Da.js"))), t.component("currency-input", s(() => import("./currency-input-CCdAZz29.js"))), t.component("tag-input", s(() => import("./tag-input-CpBTfq7I.js"))), t.component("file-input", s(() => import("./file-input-BKdZbe6E.js"))), t.component("number-input", s(() => import("./number-input-C-plLrOu.js"))), t.component("date-picker", s(() => import("./date-picker-BTMrPKRv.js"))), t.component("time-input", s(() => import("./time-input-Cb3AaoUk.js"))), t.component("search-input", s(() => import("./search-input-B_7_nFoB.js"))), t.component("phone-input", s(() => import("./phone-input-CVBSL2X7.js"))), t.component("drag-drop-uploader", s(() => import("./drag-drop-uploader-ByQO2Dc9.js")));
}
const Q = {
  position: "top",
  color: "dark",
