...
function R(t) {
  t.component("column", n(() => import("./column-DFEEo01k.js"))), t.component("columns", n(() => import("./columns-CNwTQcJ_.js"))), t.component("flex", n(() => import("./flex-C24puy0P.js")));
}
function X(t) {
  t.component("base-icon", n(() => import("./base-icon-D9TihyI9.js"))), t.component("action-button", n(() => import("./button-CecB7Pv-.js"))), t.component("icon-button", n(() => import("./icon-button-BiahoDPt.js"))), t.component("submit-button", n(() => import("./submit-button-BBryhJxf.js"))), t.component("buttons", n(() => import("./buttons-DZb92DV0.js"))), t.component("loader", n(() => import("./loader-DV0AsbIS.js"))), t.component("block", n(() => import("./block-CnLxX0Xp.js"))), t.component("box", n(() => import("./box-D0pj8ufI.js"))), t.component("b-icon", n(() => import("./icon-XTRTXlk0.js"))), t.component("avatar", n(() => import("./avatar-Qs3jleId.js")));
}
function Y(t) {
  t.component("side-menu", n(() => import("./side-menu-BDzvTklI.js"))), t.component("side-menu-label", n(() => import("./side-menu-label-2Zq5io12.js"))), t.component("side-menu-list", n(() => import("./side-menu-list-DtNIY1Wn.js"))), t.component("side-menu-list-item", n(() => import("./side-menu-list-item-CRcqKWHK.js"))), t.component("dropdown", n(() => import("./dropdown-BFSCP8ZA.js"))), t.component("dropdown-divider", n(() => import("./dropdown-divider-DZ1yvyDp.js"))), t.component("dropdown-item", n(() => import("./dropdown-item-BU3bgDwG.js"))), t.component("dropdown-trigger", n(() => import("./dropdown-trigger-DTlJTm2u.js"))), t.component("modal", n(() => import("./modal-C5xJoYjS.js"))), t.component("confirm", n(() => import("./confirm-dialog-D2lNlEAL.js"))), t.component("alert", n(() => import("./alert-dialog-Cx7UVq1h.js"))), t.component("tabs", n(() => import("./tabs-BgHChJGc.js"))), t.component("tab", n(() => import("./tab-DkodDZA8.js"))), t.component("pagination", n(() => import("./pagination-C8Y1xs4n.js")));
}
function B(t) {
  t.component("field-label", n(() => import("./field-label-BlqTt41h.js"))), t.component("text-input", n(() => import("./text-input-DB1TqUbb.js"))), t.component("password-input", n(() => import("./password-input-CYj3PcqC.js"))), t.component("text-area", n(() => import("./text-area-BLLtHf0h.js"))), t.component("select-input", n(() => import("./select-input-CDT_VF1_.js"))), t.component("radio-input", n(() => import("./radio-input-B1Dp5itf.js"))), t.component("checkbox-input", n(() => import("./checkbox-input-B_xSXtDh.js"))), t.component("switch-input", n(() => import("./switch-input-DqyyquBs.js"))), t.component("currency-input", n(() => import("./currency-input-D08wAQyo.js"))), t.component("tag-input", n(() => import("./tag-input-CFTLx0Um.js"))), t.component("file-input", n(() => import("./file-input-DZouJbmP.js"))), t.component("number-input", n(() => import("./number-input-C9Yumz5J.js"))), t.component("date-picker", n(() => import("./date-picker-BPbWfmv8.js"))), t.component("time-input", n(() => import("./time-input-IRoEV9yT.js")));
}
const N = {
  position: "top",
  color: "dark",
