import { defineComponent as V, ref as k, watch as L, resolveComponent as m, createElementBlock as i, openBlock as o, createBlock as c, createCommentVNode as u, createElementVNode as r, createVNode as E, withCtx as y, renderSlot as f, normalizeClass as B, unref as S, withDirectives as w, toDisplayString as v, Fragment as K, renderList as $, vModelSelect as q } from "vue";
  ...
  setup(b, { emit: g }) {
    ...
    return (e, l) => {
      ...
      return o(), i("div", null, [
          ...
          r("div", {
            ...
            r("div", {
              ...
              w(r("select", {
                ...
                (o(!0), i(K, null, $(e.items, (a) => (o(), i("option", {
                  value: a[e.valueKey],
                  key: a[e.valueKey]
        ...
        E(z, { error: e.error }, null, 8, ["error"])
      ]);
    };
  }
});
