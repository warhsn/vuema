import { defineComponent as p, computed as r, resolveComponent as y, createElementBlock as s, openBlock as i, withModifiers as d, normalizeClass as B, createCommentVNode as t, createElementVNode as u, createVNode as m, renderSlot as g, createBlock as h } from "vue";
const f = ["disabled"], v = {
  key: 0,
  class: "icon"
}, I = {
  ...
  setup(o) {
    ...
    return (n, l) => {
      ...
      return i(), s("button", {
        ...
        onClick: l[0] || (l[0] = d((k) => n.$emit("submit"), ["prevent"]))
      }, [
        o.leftIcon ? (i(), s("span", v, [
          m(a, { icon: o.leftIcon }, null, 8, ["icon"])
        ])) : t("", !0),
        u("span", null, [
          g(n.$slots, "default")
        ]),
