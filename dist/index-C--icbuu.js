...
const I = v({
  ...
  setup(t) {
    const o = C([]), e = T(() => `toast-${t.position}`), r = (m) => {
      const s = Date.now();
      setTimeout(() => {
        o.value.push({ ...m, id: s });
      }, o.value.length * 100), m.timeout !== 0 && setTimeout(() => {
        i(s);
      }, m.timeout || 3e3);
    }, i = (m) => {
      const s = o.value.findIndex((p) => p.id === m);
...
function L(t, o, e, r, i, m) {
  return a(), u("div", {
    ...
    w(_, {
      ...
      default: k(() => [
        (a(!0), u(A, null, x(t.notifications, (s) => (a(), u("div", {
          key: s.id,
          class: "notification-wrapper"
        }, [
          l("div", {
            class: d(["notification", s.type])
          }, [
            l("button", {
              class: "delete",
              onClick: (p) => t.removeToast(s.id)
            }, null, 8, F),
            E(" " + $(s.message), 1)
          ], 2)
        ]))), 128))
...
const f = /* @__PURE__ */ N(I, [["render", L], ["__scopeId", "data-v-04e8babe"]]);
class O {
  constructor(o = "bottom-right", e = 4e3, r = "toast") {
    c(this, "toastApp");
    c(this, "toastComponent");
    c(this, "position");
    c(this, "timeout");
    c(this, "transition");
    this.position = o, this.timeout = e, this.transition = r;
...
const j = {
  ...
  install: (t, o = j) => {
    ...
    V(t), B(t), D(t), P(t);
    const e = new O(
      (r = o == null ? void 0 : o.toaster) == null ? void 0 : r.position,
