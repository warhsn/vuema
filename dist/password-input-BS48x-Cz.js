import { defineComponent as _, ref as $, computed as y, resolveComponent as m, openBlock as n, createElementBlock as d, createVNode as c, withCtx as h, renderSlot as f, createElementVNode as u, normalizeClass as o, createCommentVNode as i, createBlock as g } from "vue";
import { _ as N } from "./errors-BZdmzG52.js";
import { _ as T } from "./field-error.vue_vue_type_script_setup_true_lang-DiGo15DQ.js";
const q = ["type", "placeholder", "disabled", "value"], L = { class: "control" }, P = "update:modelValue", z = /* @__PURE__ */ _({
  ...
  setup(v, { emit: b }) {
    ...
    const C = N(l), s = y(() => ({
      ...
      for (const [a, t] of Object.entries(B.value))
        t && e.push(a);
