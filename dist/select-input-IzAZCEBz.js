import { defineComponent as h, resolveComponent as s, openBlock as o, createElementBlock as n, createVNode as i, withCtx as g, renderSlot as C, createElementVNode as t, normalizeClass as r, unref as I, toDisplayString as p, createCommentVNode as d, Fragment as k, renderList as L, createBlock as E } from "vue";
...
const N = ["multiple", "disabled", "size"], S = {
  key: 0,
  value: ""
}, q = ["value", "selected"], w = "update:modelValue", D = /* @__PURE__ */ h({
  __name: "select-input",
  props: {
    valueKey: {},
    labelKey: {},
  ...
  setup(u, { emit: c }) {
    ...
    const f = K(y);
    return (e, a) => {
      const b = s("field-label"), v = s("b-icon");
      return o(), n("div", null, [
