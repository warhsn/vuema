import { defineComponent as E, resolveComponent as B, openBlock as i, createElementBlock as u, createVNode as g, withCtx as $, renderSlot as d, createElementVNode as f, normalizeClass as y, createCommentVNode as p, unref as I, createBlock as v } from "vue";
...
const L = () => {
  ...
  key: 1,
  class: "control"
}, P = "update:modelValue", R = /* @__PURE__ */ E({
  __name: "number-input",
  props: {
    modelValue: {},
    min: {},
  ...
  setup(a, { emit: r }) {
    ...
    return (e, m) => {
      ...
      return i(), u("div", null, [
        ...
        f("div", {
          class: y(["field", { "has-addons": e.hasAddons }])
        }, [
