...
function D(t) {
  t.component("column", n(() => import("./column-CCAP556S.js"))), t.component("columns", n(() => import("./columns-DWoNJgSX.js"))), t.component("flex", n(() => import("./flex-na4e2Z6E.js")));
}
function B(t) {
  t.component("base-icon", n(() => import("./base-icon-B-tbkkJe.js"))), t.component("action-button", n(() => import("./button-hK6oV9xO.js"))), t.component("icon-button", n(() => import("./icon-button-DJGpY_Pf.js"))), t.component("submit-button", n(() => import("./submit-button-DYsgDvB_.js"))), t.component("buttons", n(() => import("./buttons-C2PrXJUd.js"))), t.component("loader", n(() => import("./loader-DtUGcKsx.js"))), t.component("block", n(() => import("./block-Diw3qohk.js"))), t.component("box", n(() => import("./box-CUwdGAU1.js"))), t.component("b-icon", n(() => import("./icon-iMiYgm47.js"))), t.component("avatar", n(() => import("./avatar-DuymQACc.js")));
}
function I(t) {
  t.component("side-menu", n(() => import("./side-menu-D2_kkb3-.js"))), t.component("side-menu-label", n(() => import("./side-menu-label-YFI9PR1Y.js"))), t.component("side-menu-list", n(() => import("./side-menu-list-BcZHk4wD.js"))), t.component("side-menu-list-item", n(() => import("./side-menu-list-item-B1sQk9MU.js"))), t.component("dropdown", n(() => import("./dropdown-BP_CwBx3.js"))), t.component("dropdown-divider", n(() => import("./dropdown-divider-Dv1Mv2EE.js"))), t.component("dropdown-item", n(() => import("./dropdown-item-BUIdaown.js"))), t.component("dropdown-trigger", n(() => import("./dropdown-trigger-C9QKT2QF.js"))), t.component("modal", n(() => import("./modal-bYere2Ki.js"))), t.component("confirm", n(() => import("./confirm-dialog-BQTZ5qyU.js"))), t.component("alert", n(() => import("./alert-dialog-w-nS6SoS.js"))), t.component("tabs", n(() => import("./tabs-CijP3t8Y.js"))), t.component("tab", n(() => import("./tab-C-ZFdJQY.js")));
}
const N = C({
  name: "Toast",
  props: {
...
function R(t) {
  t.component("field-label", n(() => import("./field-label-B7n3LkGe.js"))), t.component("text-input", n(() => import("./text-input-YsWYud3U.js"))), t.component("password-input", n(() => import("./password-input-tBB4pK44.js"))), t.component("text-area", n(() => import("./text-area-BtFpKQ0w.js"))), t.component("select-input", n(() => import("./select-input-OC64zcOw.js"))), t.component("radio-input", n(() => import("./radio-input-CwUYajP3.js"))), t.component("checkbox-input", n(() => import("./checkbox-input-DtBpftvj.js"))), t.component("switch-input", n(() => import("./switch-input-CwbDCiD0.js"))), t.component("currency-input", n(() => import("./currency-input-DqYkxU7X.js"))), t.component("tag-input", n(() => import("./tag-input-DwwCvg4V.js"))), t.component("file-input", n(() => import("./file-input-BIsSd6C-.js"))), t.component("number-input", n(() => import("./number-input-_Q__nRcB.js"))), t.component("date-picker", n(() => import("./date-picker-DYB5UIMw.js")));
}
function H(t, o = 50) {
  let e;
  return V((s, i) => ({
