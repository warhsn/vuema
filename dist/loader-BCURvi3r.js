...
import { _ as g } from "./index-C50mDJvf.js";
const x = /* @__PURE__ */ s({
  __name: "loader",
  props: {
    ...
    return (t, v) => {
      ...
      return e(), n("div", {
        ...
        t.loading ? (e(), f(i, {
          ...
          default: m(() => [
            (e(), n("svg", y(_({ viewBox: "0 0 50 50", style: { width: "48px", height: "48px" } })), [
              o("circle", r({ class: "spinner" }, { cx: 25, cy: 25, r: 20 }, {
                fill: "none",
                "stroke-width": "1"
              }), null, 16),
              o("circle", r({ class: "dot" }, { cx: 10, cy: 10, r: 2 }), null, 16)
            ], 16))
          ]),
          _: 1
