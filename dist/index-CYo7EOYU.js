...
function D(t) {
  t.component("column", n(() => import("./column-DFEEo01k.js"))), t.component("columns", n(() => import("./columns-CNwTQcJ_.js"))), t.component("flex", n(() => import("./flex-CZTUIhmU.js")));
}
function B(t) {
  t.component("base-icon", n(() => import("./base-icon-D9TihyI9.js"))), t.component("action-button", n(() => import("./button-CecB7Pv-.js"))), t.component("icon-button", n(() => import("./icon-button-BiahoDPt.js"))), t.component("submit-button", n(() => import("./submit-button-BBryhJxf.js"))), t.component("buttons", n(() => import("./buttons-DZb92DV0.js"))), t.component("loader", n(() => import("./loader-BhQSM55j.js"))), t.component("block", n(() => import("./block-Itgi6fmk.js"))), t.component("box", n(() => import("./box-CE0NbgAo.js"))), t.component("b-icon", n(() => import("./icon-XTRTXlk0.js"))), t.component("avatar", n(() => import("./avatar-RaTeF3Gk.js")));
}
function I(t) {
  t.component("side-menu", n(() => import("./side-menu-CkA6X4_e.js"))), t.component("side-menu-label", n(() => import("./side-menu-label-Dw2nsqC2.js"))), t.component("side-menu-list", n(() => import("./side-menu-list-B2dlaWoL.js"))), t.component("side-menu-list-item", n(() => import("./side-menu-list-item-DZVfFgUT.js"))), t.component("dropdown", n(() => import("./dropdown-BFSCP8ZA.js"))), t.component("dropdown-divider", n(() => import("./dropdown-divider-DCYcwaAH.js"))), t.component("dropdown-item", n(() => import("./dropdown-item-BU3bgDwG.js"))), t.component("dropdown-trigger", n(() => import("./dropdown-trigger-DTlJTm2u.js"))), t.component("modal", n(() => import("./modal-DOnTKQ2u.js"))), t.component("confirm", n(() => import("./confirm-dialog-D2lNlEAL.js"))), t.component("alert", n(() => import("./alert-dialog-BxM5Y4SM.js"))), t.component("tabs", n(() => import("./tabs-BgHChJGc.js"))), t.component("tab", n(() => import("./tab-DkodDZA8.js"))), t.component("pagination", n(() => import("./pagination-CWJ6mKMs.js")));
}
const N = C({
  name: "Toast",
  props: {
