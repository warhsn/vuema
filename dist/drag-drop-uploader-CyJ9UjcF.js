...
const J = ["multiple", "accept"], G = { class: "drag-drop-content" }, K = {
  ...
  setup(p, { emit: w }) {
    ...
    function T(s) {
      ...
      c.multiple ? d.value.push(...o) : d.value = o.slice(0, 1), g("filesSelected", r);
    }
    function S(s) {
      d.value.splice(s, 1);
    }
    ...
    async function N(s) {
      return new Promise((r, o) => {
        ...
        t.upload.addEventListener("progress", (a) => {
          a.lengthComputable && (s.progress = Math.round(a.loaded / a.total * 100), g("uploadProgress", { file: s.file, progress: s.progress }));
    ...
    return (s, r) => {
      ...
      return n(), i("div", null, [
        ...
        l("div", {
          ...
          l("div", G, [
            d.value.length === 0 ? (n(), i("div", K, [
              ...
              (n(!0), i(O, null, P(d.value, (e, t) => (n(), i("div", {
                key: t,
                class: _(["file-item", {
        ...
        z(q, { error: p.error }, null, 8, ["error"])
      ]);
    };
  }
