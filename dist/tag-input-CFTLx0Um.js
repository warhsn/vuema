import { defineComponent as g, ref as v, resolveComponent as h, createElementBlock as s, openBlock as i, createVNode as _, createElementVNode as l, withCtx as V, renderSlot as d, Fragment as C, renderList as I, createTextVNode as T, toDisplayString as x, withDirectives as b, withKeys as k, vModelText as N } from "vue";
  ...
  setup(c, { emit: u }) {
    ...
    return (t, o) => {
      ...
      return i(), s("div", null, [
        ...
        l("div", q, [
          l("div", w, [
            (i(!0), s(C, null, I(t.modelValue, (e, f) => (i(), s("span", {
              class: "tag",
              key: f
            }, [
              T(x(e) + " ", 1),
